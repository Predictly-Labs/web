    ...
    <section className="relative py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div>
          ...
          >
            Predictly <span className="text-blue-500">redefines</span> prediction market
            <br />
            that <span className="text-gray-500">empowers</span> professionals and enthusiasts alike
            <br />
            to embrace the <span className="text-blue-500">future of predictions</span>.
          </motion.h2>
